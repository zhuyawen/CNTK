...
\
    ...
    CNTK_API FunctionPtr GlobalConcat(const Variable& feature, const std::wstring memoryBlockName, size_t memoryLength, size_t segmentIndex, const std::wstring& name = L"");
