...
public:
    ...
    ComputationNodePtr GlobalConcat(const ComputationNodePtr a, std::wstring memoryBlockName, size_t memoryLength, size_t segmentIndex, const std::wstring nodeName = L"");
