...
template <class ElemType>
__global__ void _asoftmaxForward2(ElemType lambda, size_t outputDimension, const ElemType* label, ElemType* value, const ElemType* inputMagnitude,
                                           ...
                                           const GPUMatrix<ElemType>& cosThetaQuadratic, const GPUMatrix<ElemType>& sign0)
{
    ...
    _asoftmaxForward2<ElemType> << <grid.m_blocksPerGrid, grid.m_threadsPerBlock, 0, t_stream >> > (lambda, outputDimension, label.Data(), value.Data(), inputMagnitude.Data(),
        cosThetaQuadratic.Data(), sign0.Data());
}


template <class ElemType>
__global__ void _asoftmaxForward3(ElemType lambda, size_t outputDimension, const ElemType* label, ElemType* value, const ElemType* inputMagnitude,
                                           ...
                                           const GPUMatrix<ElemType>& cosTheta, const GPUMatrix<ElemType>& cosThetaCubic, const GPUMatrix<ElemType>& sign1, const GPUMatrix<ElemType>& sign2)
{
    SyncGuard syncGuard;
    GridDim grid(minibatchSize);
    _asoftmaxForward3<ElemType> << <grid.m_blocksPerGrid, grid.m_threadsPerBlock, 0, t_stream >> > (lambda, outputDimension, label.Data(), value.Data(), inputMagnitude.Data(),
        cosTheta.Data(), cosThetaCubic.Data(), sign1.Data(), sign2.Data());
}


template <class ElemType>
__global__ void _asoftmaxForward4(ElemType lambda, size_t outputDimension, const ElemType* label, ElemType* value, const ElemType* inputMagnitude,
                                           ...
                                           const GPUMatrix<ElemType>& cosThetaQuadratic, const GPUMatrix<ElemType>& cosThetaQuartic, const GPUMatrix<ElemType>& sign3, const GPUMatrix<ElemType>& sign4)
{
    SyncGuard syncGuard;
    GridDim grid(minibatchSize);
    _asoftmaxForward4<ElemType> << <grid.m_blocksPerGrid, grid.m_threadsPerBlock, 0, t_stream >> > (lambda, outputDimension, label.Data(), value.Data(), inputMagnitude.Data(),
        cosThetaQuadratic.Data(), cosThetaQuartic.Data(), sign3.Data(), sign4.Data());
}


template <class ElemType>
__global__ void _asoftmaxBackward2(ElemType lambda, size_t inputDimension, size_t outputDimension, const ElemType* label, const ElemType* gradient, ElemType* X_gradient, const ElemType* inputMagnitude, const ElemType* X, const ElemType* weight,
                                   const ElemType* cosTheta, const ElemType* cosThetaQuadratic, const ElemType* sign0)
{
    CUDA_LONG X_id = GridDim::GetLinearThreadId();
    size_t col = X_id / inputDimension; // sample id, indicate the sample[col]
    size_t row = X_id % inputDimension; // feature id, indicate the feature[row]
    size_t labelValue = static_cast<size_t>(label[col]);
    size_t W_id = row * outputDimension + labelValue;
    size_t index = col * outputDimension + labelValue;
...
template <class ElemType>
__global__ void _asoftmaxBackward3(ElemType lambda, size_t inputDimension, size_t outputDimension, const ElemType* label, const ElemType* gradient, ElemType* X_gradient, const ElemType* inputMagnitude, const ElemType* X, const ElemType* weight,
...
template <class ElemType>
__global__ void _asoftmaxBackward4(ElemType lambda, size_t inputDimension, size_t outputDimension, const ElemType* label, const ElemType* gradient, ElemType* X_gradient, const ElemType* inputMagnitude, const ElemType* X, const ElemType* weight,
